...
public class MasteredDefense extends AbstractFairyCard {

    //card Info
    public static final String ID = TheFairyMod.makeID("MasteredDefense");
    ...
    private static final int DEX_PLUS_AMT = 1;

    //card Initialize
    public MasteredDefense() {
        super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET);
        magicNumber = baseMagicNumber = DEX_AMT;
    }
    ...
    public void upgrade() {
        if (!upgraded) {
            upgradeName();
            upgradeMagicNumber(DEX_PLUS_AMT);
