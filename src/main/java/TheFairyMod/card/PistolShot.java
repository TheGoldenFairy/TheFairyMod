...
public class PistolShot extends AbstractFairyCard {

    //card Info
    public static final String ID = TheFairyMod.makeID("PistolShot");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        for (AbstractMonster mo : (AbstractDungeon.getCurrRoom()).monsters.monsters) {
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(mo, p, new WeakPower(mo, magicNumber, false), WEAK_AMT, true, AbstractGameAction.AttackEffect.NONE));
        }
    }
