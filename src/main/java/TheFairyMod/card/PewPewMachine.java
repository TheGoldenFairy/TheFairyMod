...
public class PewPewMachine extends AbstractFairyCard {
    //card Info
    public static final String ID = TheFairyMod.makeID("PewPewMachine");
    ...
    //card Initialize
    public PewPewMachine() {
        super(ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET);
        baseDamage = DAMAGE;
        magicNumber = baseMagicNumber = BULLET_AMT;
        fairyBaseSecondMagicNumber = fairySecondMagicNumber = ADDITIONAL_DMG;
