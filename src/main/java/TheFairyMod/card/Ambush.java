...
public class Ambush extends AbstractFairyCard {

    //card Info
    public static final String ID = TheFairyMod.makeID("Ambush");
    ...
    public Ambush() {
        ...
        fairySecondMagicNumber = fairyBaseSecondMagicNumber = WEAK_AND_VUL_AMT;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if(AbstractDungeon.player.hasPower(BulletPower.POWER_ID) && AbstractDungeon.player.getPower(BulletPower.POWER_ID).amount >= magicNumber) {
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(m, p, new WeakPower(m, fairySecondMagicNumber, false)));
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(m, p, new VulnerablePower(m, fairySecondMagicNumber, false)));
    ...
    public void upgrade() {
        if (!upgraded) {
            upgradeName();
            upgradeFairySecondMagicNumber(WEAK_AND_VUL_AMT_PLUS);
