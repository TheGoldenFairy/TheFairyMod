...
public class BurningDesirePower extends AbstractPower {
    private static final String POWER_ID = TheFairyMod.makeID("BurningDesirePower");
    ...
    public BurningDesirePower(final AbstractCreature owner, final int amount) {
        name = NAME;
        ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
